...
var {
  ...
  NativeModules: {
    ...
    FullScreenWebViewBridgeManager
  }
} = ReactNative;
var { PropTypes } = React;
...
class FullScreenWebViewBridge extends React.Component {
  static propTypes = {
  ...
  render() {
    return (
      <RCTFullScreenWebViewBridge {...this.props} />
    );
  }
}

const RCTFullScreenWebViewBridge = requireNativeComponent(
  'RCTFullScreenWebViewBridge', FullScreenWebViewBridge
);
...
module.exports = { WebViewBridge, FullScreenWebViewBridge };
